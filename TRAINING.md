...
- **Independent Seed Credentials**: Running \
pm run db:seed\ creates fresh, randomly generated passwords saved in \SEED_CREDENTIALS.txt\ inside this folder.
